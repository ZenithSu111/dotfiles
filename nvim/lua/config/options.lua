vim.cmd("let g:netrw_banner = 0") -- 將nvim的netrw目錄訊息隱藏
...
vim.opt.tabstop = 4           -- Tab 寬度為 4 空格
vim.opt.shiftwidth = 4        -- >> << 操作時移動 4 空格
vim.opt.softtabstop = 4       -- 按下 Tab 鍵時插入 4 空格
vim.opt.expandtab = true      -- 將 Tab 轉換為空格
vim.opt.smartindent = true    -- 根據語法自動縮排
vim.opt.autoindent = true     -- 自動繼承前一行的縮排
-- vim.opt.colorcolumn = "100"   -- 最大行數
